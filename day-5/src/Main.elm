...
type alias InstructionConstructor =
    (Param -> Param -> Address -> Instruction)

-- Helper


readRegister : Address -> Program -> Result Error Int
...
parse3Instruction fn pc program =
    Result.map3 fn
...
parseInstruction :
    ...
    -> Program
    -> Result Error ParseOperationOutput
parseInstruction = -- Add code here
...
parseOperation pc program operationCode =
    case operationCode of
        1 ->
            parseInstruction Add pc program

        2 ->
            parseInstruction Multiply pc program
